...
(
    Cno NVARCHAR(50) CONSTRAINT FK_C_SC FOREIGN KEY (Cno) REFERENCES C(Cno) ON UPDATE CASCADE ON DELETE CASCADE,--课号
    Sno NVARCHAR(50) CONSTRAINT FK_S_SC FOREIGN KEY (Sno) REFERENCES S(Sno) ON UPDATE CASCADE ON DELETE CASCADE,--学号
